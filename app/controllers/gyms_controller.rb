class GymsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @gym.save
        format.html { redirect_to @gym, notice: 'Workout created' }
  ...
  def update
    respond_to do |format|
      if @gym.update(gym_params)
        format.html { redirect_to @gym, notice: 'Workout updated' }
  ...
  def destroy
    @gym.destroy
    respond_to do |format|
      format.html { redirect_to @gym, notice: 'Workout deleted' }
